...
function SetBackColor(cl,text) {
    ...
    switch (color) {
        case "red":
            cursor.bg.red().bold().underline().write("Wellcome : " + text)
            break;
        case "green":
            cursor.bg.green().bold().underline().write("Wellcome : " + text)
            break;
        case "yellow":
            cursor.bg.yellow().bold().underline().write("Wellcome : " + text)
            break;
        case "white":
            cursor.bg.white().bold().underline().write("Wellcome : " + text)
            break;
        case "blue":
            cursor.bg.blue().bold().underline().write("Wellcome : " + text)
            break;
    ...
    switch (color) {
        ...
        case "white":
            cursor
                ...
                //      to avoid Terminal glitches 
                .write('\n')           // And a final \n to wrap things up 
            console.log('Wellcome ' + text + ', Elearnpad')
